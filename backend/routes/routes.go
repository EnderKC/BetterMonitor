...
func SetupRoutes(r *gin.Engine) {
	...
	api := r.Group("/api")
	{
		...
		auth.Use(middleware.JWTAuthMiddleware())
		{
			...
			auth.GET("/servers/:id/websites/:domain", controllers.GetWebsiteDetail)
			auth.GET("/servers/:id/websites/:domain/nginx", controllers.GetWebsiteNginxConfig)
			auth.PUT("/servers/:id/websites/:domain/nginx", controllers.SaveWebsiteNginxConfig)
